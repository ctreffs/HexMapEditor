...
class GameViewController: NSViewController, NSCollectionViewDataSource, NSCollectionViewDelegateFlowLayout {
    ...
    private var previousCell: HexCoordinates?
...
class CellViewItem: NSCollectionViewItem {
    ...
    private var colorButton: MenuButton<CellType>?
    private var elevationButton: CheckButton?
    private var elevationSlider: Slider?
    private var waterLevelButton: CheckButton?
    private var waterLevelSlider: Slider?
    private var riverButton: MenuButton<RiverType>?
    private var brushSlider: Slider?
    ...
    override init(nibName nibNameOrNil: NSNib.Name?, bundle nibBundleOrNil: Bundle?) {
        ...
        self.contentView.edgeInsets = NSEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
